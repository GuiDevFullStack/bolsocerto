    ...
    // Slide 3 - Transactions (daily expenses)
    {
      content: (
        <div className="py-4">
          ...
          <p className="text-xs text-primary font-medium text-center mb-3 bg-primary/10 rounded-full py-1 px-3 inline-block w-full">
            💡 Gastos esporádicos do dia a dia
          </p>
          <p className="text-sm text-muted-foreground text-center mb-4">
            ...
            <div className="overflow-hidden">
              ...
              >
                {slides.map((slide, index) => (
                  <Slide key={index}>{slide.content}</Slide>
                ))}
              </motion.div>
            </div>
